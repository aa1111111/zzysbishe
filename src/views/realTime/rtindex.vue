      ...
      <el-row>
            ...
            <div class="main-inner">
              <el-row>
                <el-col :span="7">
                  ...
                  >
                    <ranking-bar ref="topConfirmedCountRankChart"
                      :data="top10ProvinceData"
                      style="width: 100%; height: 380px"></ranking-bar> 
                  </chart-card>
                  <!-- 占比 -->
                  <chart-card
                    title="占比"
        ...
        <el-col :span="6">
          ...
          <div class="main-right">
            ...
            <chart-card title="各省累计确诊" :customClass="`chart-item-bottom-sep1`">
...
import RankingBar from '../realTime/components/RankingBar/index.vue'
import ChartCard from '../realTime/components/ChartCard/index.vue'

import BasicProportionChart from '../realTime/components/BasicProportionChart/index.vue'
import BasicDataItemLabel from '../realTime/components/BasicDataItemLabel/index.vue'
import DataMap from '../realTime/components/DataMap/index.vue'
import CuredAndDeadRateChart from '../realTime/components/CuredAndDeadRateChart/index.vue'
import BasicTrendChart from '../realTime/components/BasicTrendChart/index.vue'
import CurrentConfirmedCompareBarChart from '../realTime/components/currentConfirmedCompareBarChart/index'
...
// 数据样式
const getNumberStyle = (color = '#E8EAF6', fontSize = 18, fontWeight = 'bold') => {
  return {
    fontSize: fontSize,
    fill: color,
